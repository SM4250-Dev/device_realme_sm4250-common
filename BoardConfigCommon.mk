...
COMMON_PATH := device/realme/sm4250-common
...
# Init
TARGET_INIT_VENDOR_LIB ?= //$(COMMON_PATH):init_realme_bengal
TARGET_RECOVERY_DEVICE_MODULES ?= init_realme_bengal
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE :=  8087666688 # BOARD_SUPER_PARTITION_SIZE - 4MB
...
include vendor/realme/sm4250-common/BoardConfigVendor.mk
